...
for j in range(n):
    for i in range(n):
        ...
        s_y = "m.addConstr("
        s_z = "m.addConstr("
        s_x += " X_" + str(j) + "_" + str(i) + "==or_([x_" + str(j) + "_" + str(i) + ","
        s_y += " Y_" + str(j) + "_" + str(i) + "==or_([y_" + str(j) + "_" + str(i) + ","
        s_z += " Z_" + str(j) + "_" + str(i) + "==or_([z_" + str(j) + "_" + str(i) + ","
        for k in range(n):
            if k != j:
        ...
        s_y = s_y[:-1]
        s_z = s_z[:-1]
        exec(s_x+ "])" + ", \"" + "c_x_" + str(j) + "_" + str(i) + "\")")
        exec(s_y+ "])" + ", \"" + "c_y_" + str(j) + "_" + str(i) + "\")")
        exec(s_z+ "])" + ", \"" + "c_z_" + str(j) + "_" + str(i) + "\")")
        exec("m.addLConstr(X_" + str(j) + "_" + str(i) + " + y_" + str(j) + "_" + str(i) +" + z_" + str(j) + "_" + str(i) + "<= 1)")
        exec("m.addLConstr(x_" + str(j) + "_" + str(i) + " + Y_" + str(j) + "_" + str(i) +" + z_" + str(j) + "_" + str(i) + "<= 1)")
        exec("m.addLConstr(x_" + str(j) + "_" + str(i) + " + y_" + str(j) + "_" + str(i) +" + Z_" + str(j) + "_" + str(i) + "<= 1)")
