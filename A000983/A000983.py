...
# Computes a(n) for OEIS A000983 
# ( Domination number of the n-hypercube graph Q_n.)

# ((equivalently, the size of minimal binary covering code of length n and covering radius 1.))
